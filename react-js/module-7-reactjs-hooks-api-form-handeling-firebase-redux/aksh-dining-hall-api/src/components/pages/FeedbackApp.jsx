...
//destructuring  
const[selectedValue,setRateData]=useState("");
...
// call api of post data or give feedback
const addFormData=(e)=>{
  e.preventDefault();
  var insertData={
  ...
  // call api of add feedback via axios.post()
...
<form className="space-y-8" onSubmit={addFormData}>
...
placeholder="Enter your name" ref={fullname}
type="text" required
/>
</div>
...
<input
className="w-full bg-surface-container-lowest border-outline-variant/20 border rounded-lg px-4 py-3 focus:ring-2 focus:ring-secondary focus:border-transparent outline-none transition-all"
placeholder="your@email.com" ref={email}
type="email" required
/>
</div>
...
1star :<input type='radio' name="rating" value="1star" ref={rate} onChange={(e)=>setRateData(e.target.value)} />
2star :<input type='radio' name="rating" value="2star" ref={rate} onChange={(e)=>setRateData(e.target.value)} />
3star :<input type='radio' name="rating" value="3star" ref={rate} onChange={(e)=>setRateData(e.target.value)} />
4star :<input type='radio' name="rating" value="4star" ref={rate} onChange={(e)=>setRateData(e.target.value)} />
5star :<input type='radio' name="rating" value="5star" ref={rate} onChange={(e)=>setRateData(e.target.value)} />
</div>
</div>
...
<div className="flex gap-4">
<input type='text' placeholder='Enter Phone numbers' ref={phone} className='w-full' required />
</div>
</div>
...
<button type="submit" className="w-full md:w-auto px-12 py-4 bg-primary text-on-primary rounded-lg font-label font-bold uppercase tracking-widest hover:bg-primary/90 active:scale-95 transition-all">
Submit Feedback
</button>
</form>
