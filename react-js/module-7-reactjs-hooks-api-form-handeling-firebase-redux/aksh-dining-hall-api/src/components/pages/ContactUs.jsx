...
const addFormData=(e)=>{
  ...
  axios.post(`http://localhost:8000/contact`,insertData).then(()=>{
    // pass tost messages    
...
<div className="mb-10">
<h2 className="text-4xl text-primary mb-2">Contact with Us!</h2>
...
<div className="flex gap-4">
<input type='text' placeholder='Enter Phone numbers' ref={subject} className='w-full' required />
</div>
</div>
