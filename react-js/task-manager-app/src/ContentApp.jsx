...
<p>
<button className="mt-2 rounded-full bg-red-500 py-1 px-4 text-white hover:bg-red-600">
  Delete
</button>

<button className="mt-2 ml-2 rounded-full bg-blue-500 py-1 px-4 text-white hover:bg-blue-600">
  Edit
</button>
